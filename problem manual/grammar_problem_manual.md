...
- 등록·톤(Register): 학술/대중, 긍정/부정, 공식/비공식 어휘 선택
...
- 의미 참조 회복: 기술용어/약어가 가리키는 선행 내용 점검
...
1. **Collocation**: 함께 쓰이는 표현인지 확인 (예: *gain insight* vs *take insight*).
2. **Register**: 학술 vs 일상, 긍정 vs 부정, 공식 vs 비공식 어휘가 문맥과 일치하는지 확인.
3. **논리 극성**: 문단의 주장/귀결 방향과 반대되는 어휘를 고르게 설계.
4. **도메인 관습**: 과학·경제 등 분야에서 통용되는 표현인지 점검.
5. **의미 해석**: 동형 이의어·문장 구조 중의성 제거, 오답 4개는 문맥상 자연스러워야 함.
6. **장거리 참조**: this/that/these/those가 가리키는 선행 내용을 정확히 회복.
