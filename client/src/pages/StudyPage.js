> /**                                                                                     
   * StudyPage: 학습/채점/결과 화면을 조정하는 컨테이너                                   
   */                                                                                     
  ...
  세요.';                                                                                 
    ...
    const handleAnswer = (answer) => {                                                    
      const elapsedForProblem = Date.now() - (startTime + (timeSpent[currentIndex] || 0));      setAnswers((prev) => ({ ...prev, [currentIndex]: answer }));                        
  ...
  setMode('config');                                                                      
                ...
                style={{ padding: '6px 10px', borderRadius: 8, border: '1px solid         
  #e5e7eb', background: '#fff', cursor: 'pointer' }}                                      
              >                                                                           
                돌아가기                                                                  
              </button>                                                                   
