...
> Latest update (2025-10-16): 관리자 페이지에 문항 신고 보드와 알림 패널을 붙이고, 학습 세션을 서버에도 저장해 어디서든 이어 풀 수 있게 만들었어요.

### 오늘의 Top 3
- 신고 데이터를 유형·문서·사용자 기준으로 필터링하고, CSV 내보내기/일괄 처리를 추가해 관리자들이 빠르게 품질 결정을 내리도록 돕습니다. (품질 의사결정)
- 👍/🚨 버튼에 디바운스와 429 토스트 안내를 붙이고, 슬랙/이메일 알림 파이프라인을 연동해 스팸을 차단하면서 사용자 경험을 개선해요. (신뢰도 향상)
- 학습 세션을 주기적으로 서버에 자동 저장하고 만료 정책을 정의해 기기 전환이나 장시간 풀이에서도 안전하게 이어 풀 수 있게 합니다. (세션 안정성)
