...
> Latest update (2025-10-20): 신고된 문항은 이제 🚨 버튼 한 번으로 숨길 수 있고, 숨긴 문제는 학습/캐시/PDF에서 자동 제외돼요. 학습 화면에는 “문제가 이상하면 신고” 안내를 덧붙여 학생이 바로 피드백을 보낼 수 있고, 기존 어휘·신고 보드 개선도 그대로 유지됩니다.
