...
1. 프로필 편집 강화 – 학교명을 "이름 + 접미사(고/여고)"로 나눠 입력해 OO여고/OO고 형태를 자동 완성하고, 학년(1/2/3)을 간단 선택하도록 개선했어요. 🏫
2. 어휘 페이지 UX – 상단 개수 문구 제거, ‘단어장 살펴보기’만 남기고 마스코트는 하단 포인터로 이동해 목록을 직접 가리켜요. 👇
3. 해설 톤+빈칸 폴백 – 해설을 쉬운 말+이모지로 고정하고, 빈칸 폴백도 2문장 이상+구/절 정답으로 바꿔 실제 시험 느낌에 가깝게 했어요. ✨
