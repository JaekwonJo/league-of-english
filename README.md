...
> Latest update (2025-10-16): PROJECT_STATE·BUILDLOG·README를 다시 맞추고, 회귀 diff·모의고사 미리보기·월고 데이터 확장 같은 최우선 과제를 재확인했어요.

### 오늘의 Top 3
- 월고 기준 세트와 새로 생성한 문제를 자동으로 비교하는 회귀 파이프라인 만들기 → 지금은 사람이 직접 확인해서 시간이 너무 오래 걸려요.
