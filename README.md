...
> Latest update (2025-10-04): 지문 미리보기 카드와 전체 보기 모달을 관리자·학생·학습 설정 화면에 통일하고, 선택한 지문 정보를 한 번에 넘길 수 있도록 공통 API를 정비했어요.

### 오늘의 Top 3
- 어법·어휘 보기 셔플과 정답 재매핑을 붙여 ③번 고정 정답 패턴을 없애요. (공정성 확보)
- 선택한 지문으로만 문제를 만들 수 있도록 백엔드 필터링을 붙여요. (UI 선택과 결과 일치)
